...
### ✅ M-7. Shared API contract ระหว่าง backend-school และ frontend — Scheduling configuration batch เสร็จแล้ว
...
| **Phase 2 scheduling-configuration operations** | six reads: `listSchedulingInstructorConstraints`, `listSchedulingSubjectConstraints`, `getSchedulingSettings`, `listSchedulingClassroomCourseConstraints`, `listSchedulingClassroomCoursePreferredRooms`, `listSchedulingRooms`; one atomic mutation: `saveSchedulingConfiguration` |
...
| **งานต่อ Phase 4 mutation-contract rollout** | Scheduling jobs/undo เป็นชุดถัดไปที่เหมาะสม; SSE, WebSocket, health/readiness และ file/binary endpoints ยังอยู่นอก OpenAPI contract โดยตั้งใจ |
| **ความยาก** | Medium |
