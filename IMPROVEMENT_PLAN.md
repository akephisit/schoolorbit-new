...
### ✅ M-7. Shared API contract ระหว่าง backend-school และ frontend — Course planning batch เสร็จแล้ว
...
| **งานต่อ Phase 4 mutation-contract rollout** | Phase 2 scheduling configuration เป็นชุดถัดไป; SSE, WebSocket, health/readiness และ file/binary endpoints ยังอยู่นอก OpenAPI contract โดยตั้งใจ |
| **ความยาก** | Medium |
