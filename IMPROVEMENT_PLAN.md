...
### ✅ M-7. Shared API contract ระหว่าง backend-school และ frontend — 177-operation checkpoint
...
| **ผลลัพธ์** | ปัจจุบัน contract มี 177 unique operations: 32 auth/authorization, 36 read-oriented JSON operations จาก checkpoint เดิม, Phase 1 people จำนวน 12 mutations พร้อม achievement list read, Phase 2 academic structure จำนวน 15 mutations พร้อม 4 dependent reads, Phase 2 curriculum core จำนวน 15 mutations พร้อม 9 dependent reads, Phase 2 activity-template จำนวน 10 mutations พร้อม 3 dependent reads, Phase 2 activity workspace จำนวน 21 mutations พร้อม 7 dependent reads และ Phase 2 course planning จำนวน 7 mutations พร้อม 5 dependent reads |
