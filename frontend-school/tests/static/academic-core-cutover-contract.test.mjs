...
test('catalog overview schemas are generated from the backend contract', async () => {
	...
	assert.ok(schemas.CatalogSubjectOverview.required.includes('subjectGroupOptions'));
	assert.ok(schemas.CatalogActivityOverview.required.includes('canCreate'));
	assert.ok(schemas.CatalogSubjectGroupOption.required.includes('canManage'));
	assert.ok(!schemas.CatalogSubjectOverview.required.includes('ownerOptions'));
	assert.ok(!schemas.CatalogActivityOverview.required.includes('ownerOptions'));
