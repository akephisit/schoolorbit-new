 ...
 */
export async function createStudent(data: CreateStudentRequest): Promise<{ success: boolean; id: string }> {
 ...
 */
export async function updateStudent(id: string, data: UpdateStudentRequest): Promise<{ success: boolean }> {
    const response = await fetch(`${BACKEND_URL}/api/students/${id}`, {
        method: 'PUT',
        credentials: 'include',
        headers: {
 ...
 */
export async function updateOwnProfile(data: UpdateOwnProfileRequest): Promise<{ success: boolean }> {
    const response = await fetch(`${BACKEND_URL}/api/student/profile`, {
        method: 'PUT',
        credentials: 'include',
        headers: {
