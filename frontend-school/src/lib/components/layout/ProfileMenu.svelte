...
{#if user}
	<DropdownMenu.Root>
		<DropdownMenu.Trigger
			class="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-accent transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
		>
			<!-- Avatar Only -->
			<div
