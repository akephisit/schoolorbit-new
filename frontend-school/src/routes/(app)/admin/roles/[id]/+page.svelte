...
<Input id="code" bind:value={role.code} placeholder="TEACHER" disabled={!isNew} required />
</div>
<div class="space-y-2">
...
<Textarea id="description" bind:value={role.description} placeholder="อธิบายบทบาทและหน้าที่" rows={3} />
</div>

<div class="space-y-2">
<Label for="category">ประเภท</Label>
<select id="category" bind:value={role.category} class="w-full px-3 py-2 border rounded-md">
