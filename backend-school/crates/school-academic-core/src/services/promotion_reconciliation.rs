...
use crate::models::{PromotionDestinationCommand, PromotionDestinationOutcome};
...
pub struct PromotionReconciliationOutcome {
...
pub async fn reconcile_decision(
    ...
    decision: &PromotionDestinationCommand,
    ...
    let creates_target = matches!(
        decision.outcome,
        PromotionDestinationOutcome::Promote
            | PromotionDestinationOutcome::Repeat
            | PromotionDestinationOutcome::Conditional
    );
    let source_status = match decision.outcome {
        PromotionDestinationOutcome::Graduate => "graduated",
        PromotionDestinationOutcome::TransferOut => "withdrawn",
        _ => "active",
    };
