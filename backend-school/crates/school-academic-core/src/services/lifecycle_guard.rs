...
pub const TRANSITION_NAMESPACE: i32 = 0x534F_4143;
pub const TRANSITION_KEY: i32 = 1;

#[derive(Debug, Clone, Copy, sqlx::FromRow)]
pub struct AcademicWriteState {
...
pub async fn lock_transition_shared(tx: &mut Transaction<'_, Postgres>) -> Result<(), AppError> {
...
pub async fn lock_transition(tx: &mut Transaction<'_, Postgres>) -> Result<(), AppError> {
...
pub async fn require_term_write(
    tx: &mut Transaction<'_, Postgres>,
    year: Uuid,
    term: Uuid,
) -> Result<(), AppError> {
...
pub async fn require_year_write_exclusive(
    tx: &mut Transaction<'_, Postgres>,
    year: Uuid,
...
pub async fn require_term_write_exclusive(
    tx: &mut Transaction<'_, Postgres>,
    year: Uuid,
    term: Uuid,
) -> Result<(), AppError> {
