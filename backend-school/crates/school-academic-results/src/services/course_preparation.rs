use super::*;
use crate::policy::results as access_policy;
use school_academic_assessment::gradebook::models::{GradebookStudent, ScoreCell, ScoreItem};
...
async fn load_workspace(
    ...
    for phase in &phases {
        ...
        let (current_roster, current_source) =
            school_academic_assessment::gradebook::services::source_checksums(
                scope.group_id,
                phase.id,
                phase.row_version,
                &phase.max_score,
