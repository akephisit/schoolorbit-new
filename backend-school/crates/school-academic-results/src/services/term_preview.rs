...
use crate::{models::*, policy::results as academic_result_access_policy};
...
pub async fn preview_student_term_in_transaction(
...
pub async fn preview_student_terms_in_transaction(
    tx: &mut Transaction<'_, Postgres>,
    students: &[Uuid],
    query: &TermResultPreviewQuery,
