...
use school_fonts::models::SchoolFontStyle;
use std::{
...
use crate::{
    ...
    verification_limiter::CertificateVerificationLimiter,
    SCHOOL_TIMEZONE,
};
...
struct IssuedRenderRow {
    ...
    page_rotation: i16,
    paper_label: String,
    layout: sqlx::types::Json<crate::models::CertificateLayoutV1>,
}
...
fn validate_issued_assets(
    layout: &crate::models::CertificateLayoutV1,
...
fn referenced_asset_ids(layout: &crate::models::CertificateLayoutV1) -> BTreeSet<Uuid> {
    layout
        .elements
        .iter()
