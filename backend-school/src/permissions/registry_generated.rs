...
// contract-sha256: bc7eded582f4a6713578f7230e519bc5da43724786a471df58d80b4998fe57d9
...
pub const ALL_PERMISSIONS: &[PermissionDef] = &[
    ...
    PermissionDef {
        ...
        name: "ลบร่างเกียรติบัตรในหน่วยงาน",
        module: "certificate",
        action: "delete",
        scope: "organization_unit",
        description: "ลบโครงการ แบบ หรือรายชื่อที่ยังไม่ออกเกียรติบัตรของหน่วยงานที่ได้รับสิทธิ์โดยตรง",
    },
    PermissionDef {
        code: codes::CERTIFICATE_DELETE_SCHOOL,
        name: "ลบร่างเกียรติบัตรทั้งโรงเรียน",
        module: "certificate",
        action: "delete",
        scope: "school",
        description: "ลบโครงการ แบบ หรือรายชื่อที่ยังไม่ออกเกียรติบัตรในขอบเขตทั้งโรงเรียน",
    },
    PermissionDef {
