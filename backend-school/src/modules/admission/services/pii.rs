...
pub fn hash_required(value: &str) -> Result<String, String> {
    ...
    Ok(field_encryption::hash_for_search(&normalized))
}

pub fn hash_optional(value: Option<&str>) -> Option<String> {
    value
        .map(normalize_national_id)
        .filter(|value| !value.is_empty())
        .map(|value| field_encryption::hash_for_search(&value))
}
...
mod tests {
    ...
    fn encrypt_application_pii_encrypts_values_and_hashes_for_lookup() {
        ...
        assert_eq!(
            ...
            field_encryption::hash_for_search("1234567890123")
        );
        ...
        assert_eq!(
            ...
            Some(field_encryption::hash_for_search("1111111111111"))
        );
        assert_eq!(
