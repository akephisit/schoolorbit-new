...
use crate::modules::supervision::models::{
    ...
    ReturnObservationRequest, SaveEvaluationRequest, SupervisionAction, SupervisionCycleProgress,
    SupervisionCycleStatus, SupervisionEvaluator, SupervisionEvaluatorAvailability,
    ...
    SupervisionTeacherStatusRow, SupervisionTemplateItemType, UpdateRequestedObservationRequest,
...
use cycles::SupervisionCycleTargetRow;
...
use shared::{
    ...
    parse_target_type, parse_template_item_type, EvaluatorReplacementState,
};
#[cfg(test)]
