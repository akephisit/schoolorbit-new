...
use crate::modules::academic::models::exam_schedule::{
    ExamRound, PersonalExamScheduleRound, PersonalExamSessionView,
};
...
use self::workspace::{build_readiness, fetch_workspace_counts_in_tx};
...
#[cfg(test)]
use self::sessions_and_conflicts::grade_level_allowed_by_day_scope;
#[cfg(test)]
use self::shared::{
...
mod tests {
    ...
    fn place_exam_session_locks_and_validates_invigilators_before_insert() {
        let source = include_str!("exam_schedule_service/sessions_and_conflicts.rs");
