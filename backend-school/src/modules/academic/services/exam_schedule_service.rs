...
use crate::modules::academic::models::exam_schedule::{
    BlockedWindow, ExamRound, ExamSessionView, PersonalExamScheduleRound, PersonalExamSessionView,
    PlaceExamSessionRequest,
};

#[cfg(test)]
use crate::modules::academic::models::exam_schedule::{
    BlockedWindowInput, ExamInvigilatorView, UpdateExamRoundRequest, UpsertDayRoomAssignmentRequest,
};

use self::invigilation::{
...
use self::rounds_and_days::mark_round_draft_after_mutation;
use self::shared::{
...
#[cfg(test)]
use self::shared::{
    add_minutes, exam_invigilator_staff_lock_keys, has_invigilator_time_conflict,
    invigilator_workload_minutes, time_ranges_overlap, InvigilatorSessionWindow,
...
mod tests {
    ...
    fn assign_invigilator_to_assignment_uses_day_level_move_semantics() {
        let source = include_str!("exam_schedule_service/invigilation.rs");
        let start = source
