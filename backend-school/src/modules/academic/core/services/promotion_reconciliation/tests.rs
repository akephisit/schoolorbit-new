use super::super::promotion_targets::tests::fixture;
use super::*;
use school_academic_core::{
    models::{
        PromotionDestinationCommand as PromotionDecisionInput,
        PromotionDestinationOutcome as PromotionDecisionOutcome,
    },
    services::promotion_students::PromotionStudentContext,
};
