...
Course planning reads require `ACADEMIC_COURSE_PLAN_READ_ALL`; mutations require
`ACADEMIC_COURSE_PLAN_MANAGE_ALL`. Services reject missing parents and mutation
